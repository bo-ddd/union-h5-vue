    ...
    <section class="main">
      ...
      <section class="main-middle">
        <section class="top" @click="toSelected">
          ...
          <section class="top_bd">
            <section class="img-o">
              <img src="../../../assets/images/sofa-1.png" alt="" />
            </section>
            <section class="img-t">
        ...
        <section class="find">
          <section class="find_header">
            <h2>发现好货</h2>
            <h4>美好新生活</h4>
          </section>
          <section class="find_bd">
            <section class="img-o">
  ...
  data() {
    return {
      values: [
        ...
        {
          icon: require("../../../assets/images/JD-2.png"),
          text: "电脑",
        },
        {
...
.wrap {
  ...
  & .main {
    ...
    & .main-top {
      ...
      background-image: linear-gradient(#fdf7f7, #fff);
    }
    & .main-middle {
      display: flex;
